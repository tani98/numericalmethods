 ...
 */
package com.developerfriend.controller;

import com.developerfriend.util.Bisection;
import com.developerfriend.util.Dialog;
import com.developerfriend.util.Function;
